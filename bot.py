...
CAUTA_BANNER_URL = "https://cdn.discordapp.com/attachments/1454800511281791017/1454950500377170045/image.png?ex=6952f3be&is=6951a23e&hm=a25d2fa5aaf593c8ffa22dfc7672556ef912f124cc0e7b4c81d4dd13a2141a33&"
...
class LFGModal(discord.ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        cauta_embed.set_image(url=CAUTA_BANNER_URL)
...
async def cauta(interaction: discord.Interaction):
    ...
    embed.set_image(url=CAUTA_BANNER_URL)
