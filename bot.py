...
class LFGModal(discord.ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        # 🔁 EDITĂM ultimul LFG din canal (dacă există)
        if channel.id in last_lfg_message:
            try:
                msg = last_lfg_message[channel.id]
                await msg.edit(
                    embed=embed,
                ...
                del last_lfg_message[channel.id]
        ...
        last_lfg_message[channel.id] = await interaction.original_response()
